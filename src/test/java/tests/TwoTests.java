...
/**
 * Created on 25/11/2016 at 10:21.
 */
...
public class TwoTests extends BaseTest{
    ...
    public void testFailLogin(String tUsername, String tPassword)
    {
        ...
        TwitterActions.loginToTwitter(tUsername,tPassword+"fail",objLoginPage);
    ...
    @Test(dependsOnMethods = {"testFailLogin"},
                    dataProvider = "logins", dataProviderClass = DataProviders.class)
    public void sendTweetTest(String tUsername, String tPassword)
    {
        driver.get(twitterLink);
        objLoginPage=new LoginPage(driver);
        Logger.log("Login to twitter account");
